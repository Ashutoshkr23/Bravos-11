...
function Partners() {
  ...
  return (
    <div className="bg-dark" id='work' style={divStyle}>
      ...
      {/*Mobiles*/}
      <div className='lg:hidden bg-dark px-auto bg-no-repeat ' style={divStyle2}>
        <div className='flex justify-between '>
          <div>
            <div className='py-16'>
              <p className='text-white  font-bold text-xs sm:text-sm tracking-widest opacity-60 ml-10 sm:ml-20'>WORK</p>
              <h1 className='text-white font-light text-2xl sm:text-3xl mt-2 w-56 ml-10 sm:ml-20'>PARTNERS IN PROGRESS</h1>
            ...
            <div className='w-full h-full flex justify-center items-center bg-transparent bg-opacity-50 z-40'>
              <div className='w-11/12 sm:w-3/4 mx-auto bg-white h-full mt-8 '>
            ...
            <div className='w-full h-full mt-8 flex justify-center items-center bg-transparent bg-opacity-50 z-40'>
                <div className='w-11/12 sm:w-3/4 mx-auto bg-white h-full '>
                <div className="grid grid-cols-3 " >
                  {logo.map((logo, index) => (
                    <div key={index} className="border px-2 py-2 border-green-2">
                      <img src={logo} alt={`Logo ${index}`} className="w-full object-contain h-full" />
