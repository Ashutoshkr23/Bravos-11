      ...
      <div>
              ...
              <div className='navbar bg-dark'>
                  <div className='mx-32 my-auto h-40 flex content-center justify-between' >
                      ...
                      <div className='flex content-center'>
                          ...
                          <button className='h-10 btn w-40 ml-12 rounded hover:bg-blue-1 hover:font-bold text-white border border-white my-auto'>Get in Touch</button>
                      </div>
                  </div>
          ...
          <nav class="bg-dark px-2  sm:px-4 py-2.5  fixed w-full z-50 top-0 left-0   ">
              <div class="container flex flex-wrap items-center justify-between mx-auto">
                  ...
                  <div class="flex ">
                      <button className='h-10 btn w-28 ml-12 rounded text-white border border-white hover:bg-blue-1 hover:font-bold my-auto mr-4'>Get in Touch</button>
                      <button
                          onClick={() => setIsOpen(!isOpen)}
