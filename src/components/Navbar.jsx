              ...
              <div className='navbar z-50 fixed inset-x-0 bg-dark opacity-95'>
                  <div className='mx-32 my-auto h-20 flex content-center justify-between' >
                      ...
                      <div className='flex content-center'>
                          ...
                          <button className='h-10 btn w-40 ml-12 rounded hover:bg-green-2 hover:font-bold hover:border-none text-white border border-white my-auto'>Get in Touch</button>
                      </div>
                  </div>
