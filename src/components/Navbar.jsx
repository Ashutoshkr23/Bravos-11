              ...
              <div className='navbar bg-dark'>
                  <div className='mx-32 my-auto h-40 flex content-center justify-between' >
                      ...
                      <div className='flex content-center'>
                          ...
                          <button className='h-10 btn w-40 ml-12 rounded text-white border border-white my-auto'>Get in Touch</button>
                      </div>
                  </div>
          ...
          <nav class="bg-dark px-2 sm:px-4 py-2.5  fixed w-full z-20 top-0 left-0   ">
              <div class="container flex flex-wrap items-center justify-between mx-auto">
                  <a href="#" class="flex items-center">
                      <img src="/assets/images/navbar/Logo.png" class="h-6 ml-3 sm:h-9" alt="Bravos Logo"/>
                  </a>
                  <div class="flex md:order-2">
                      <button className='h-10 btn w-40 ml-12 rounded text-white border border-white my-auto mr-4'>Get in Touch</button>
                      <button
                          onClick={() => setIsOpen(!isOpen)}
                          type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                          <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
                      ...
                      {isOpen && (
                          <div className="absolute right-0 mt-12 w-full bg-dark border rounded-md shadow-lg z-10">
