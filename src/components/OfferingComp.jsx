  ...
  return (
    <div>
      ...
      <div className='lg:hidden'>
        ...
        > */}
        <div className='h-[165px] w-[155px] sm:h-56 sm:w-56 drop-shadow-white rounded-md bg-white border border-green-2 mt-10 ease-out duration-200 hover:scale-[1.15]'>
