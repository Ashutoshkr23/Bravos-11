  ...
  return (
    <div>
      ...
      <div className='hidden lg:block'>
        <div className='h-80 w-80 drop-shadow-white rounded-md bg-white border border-blue-1 hover:scale-[1.15] '>
      ...
      <div className='lg:hidden'>
        ...
        > */}
        <div className='h-[165px] w-[155px] sm:h-56 sm:w-56 drop-shadow-white rounded-md bg-white border border-blue-1 mt-10 hover:scale-[1.15]'>
