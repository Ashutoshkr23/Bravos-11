  ...
  return (
    ...
    <div className='bg-dark py-20 lg:py-32 ' id='about'>
      ...
      <div className='hidden lg:block relative' >
        ...
        <p className='text-center font-thin text-5xl text-white my-24'>WE ARE <span className='font-bold text-green-2'>BRAVE.</span>  WE ARE <span className='font-bold text-green-2'>BRAVAS.</span></p>
      </div>
      {/*Mobiles*/}
