    ...
    return (
        ...
        <div className='main bg-dark'>
            <div className='mx-4 sm:mx-16 2xl:mx-32 pt-32 lg:pt-48 pb-32'>
                ...
                <p className='anim-typewriter text-xs sm:text-lg h-8 py-1 lg:text-3xl font-light text-center justify-center font-gotham lg:mt-16 text-white lg:w-[50%]'>Research Driven Approach. Quality-Based Results.</p>
            </div>
        </div>
    )
}
