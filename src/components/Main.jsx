...
function Main() {
    ...
    return (
        ...
        <div className='main bg-dark'>
            <div className='mx-8 sm:mx-16 lg:mx-32 py-16'>
                ...
                <h2 className='text-2xl sm:text-3xl lg:text-5xl text-white font-bold text-center mt-10'>HONESTLY, IT IS.</h2>
                <p className='text-sm sm:text-lg lg:text-2xl font-light text-center mt-10 lg:mt-16 text-white'>Research Driven Approach. Quality-Based Results.</p>
            </div>
        </div>
    )
}
