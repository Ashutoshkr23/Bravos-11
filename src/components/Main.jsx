    ...
    return (
        <div className='main bg-dark'>
            <div className='mx-32 py-16'>
                <h1 className="text-6xl text-blue-2 font-bold text-center" style={{ backgroundImage: `url('/assets/images/main/hero-text-bg1.png')`, backgroundClip: 'text', WebkitBackgroundClip: 'text' }}>READY TO TAKE ON MARKETING PROBLEMS LIKE IT'S OUR EVERYDAY BUISNESS.</h1>
