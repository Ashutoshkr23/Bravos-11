    ...
    return (
        ...
        <div className='main bg-dark'>
            <div className='mx-8 sm:mx-16 lg:mx-32 pt-32 lg:pt-48 pb-16'>
                <h1 className="text-[28px] sm:text-4xl lg:text-6xl text-blue-2 font-bold text-center font-Gotham" style={{ backgroundImage: `url('/assets/images/main/hero-text-bg1.png')`, backgroundClip: 'text', WebkitBackgroundClip: 'text' }}>TACKLING MARKETING ISSUES LIKE IT'S OUR EVERYDAY BUSINESS.</h1>
